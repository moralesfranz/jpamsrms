...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 15, 2024 at 01:54 AM
...
CREATE TABLE `room` (
  ...
  `dayPrice` varchar(255) NOT NULL DEFAULT '',
  `nightPrice` varchar(255) NOT NULL DEFAULT '',
...
INSERT INTO `room` (`roomNo`, `typeID`, `roomName`, `price`, `dayPrice`, `nightPrice`, `Adults`, `Children`, `roomImage`) VALUES
...
(14, 93, 'Engrande', '1800', '', '', 50, 0, 'rooms/1.jpg'),
(15, 94, 'Pamilya-Barkada', '1500', '1', '22', 20, 0, 'rooms/2.jpg'),
(16, 95, 'Kasama Kita', '1500', '', '', 20, 0, 'rooms/3.jpg'),
(17, 96, 'Relax', '1500', '', '', 20, 0, 'rooms/4.jpg'),
(18, 97, 'Standard', '500', '', '', 20, 0, 'rooms/5.jpg'),
(19, 97, 'Cabin#2', '500', '', '', 4, 0, 'rooms/6.jpg');
...
(93, 'Engrande', 'ddsdadas'),
(94, 'Pamilya-Barkada', 'dasdasdasd'),
(95, 'Kasama Kita', 'daffafa'),
(96, 'Relax', 'dasaff'),
(97, 'Standard', 'afafadfa');
