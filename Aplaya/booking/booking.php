      ...
      <!--<div class="jumbotron">-->
        <div class="">
          ...
          <tbody>
            ...
            @$payable +=  (($_SESSION['ampm'] == 'Day Tour') ? $result->dayPrice : $result->nightPrice)   ;
          ...
          <tfoot>
            <tr>
              <td colspan="4"><h5><b> <?php  echo isset($_SESSION['pay']) ? 'Order Total: &#8369 '. $_SESSION['pay'] :'Your booking cart is empty.';?></b></h5></td><td colspan="5"> 
                            <div class="" style="display: flex; flex-direction: row; gap: 5px;">
                               <?php
                               if (isset($_SESSION['magbanua_cart'])){
                                ?>
                                  <a  href="../index.php?page=6" class="btn btn-inverse" align="right"name="clear">Add Room</a>
